                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                <li class="nk-menu-item">
                                    <a href="{{route('admin.main')}}" class="nk-menu-link">
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="#" class="nk-menu-link nk-menu-toggle">
                                        ...
                                        <span class="nk-menu-text">Maxsulot</span>
                                    </a>
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{route('admin.product.index')}}" class="nk-menu-link"><span class="nk-menu-text">Maxsulot jadvali</span></a>
                                        </li>
                                        {{--<li class="nk-menu-item">
                                            <a href="html/crm/warehouse.html" class="nk-menu-link"><span class="nk-menu-text">Warehouse</span></a>
                                        </li>--}}
                                        <li class="nk-menu-item">
                                            <a href="{{route('admin.production.index')}}" class="nk-menu-link"><span class="nk-menu-text">Tayyor Maxsulot</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
                                {{--
